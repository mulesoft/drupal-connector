...
/**
 * CreateUserMessageProcessor invokes the {@link org.mule.modules.drupal.DrupalConnector#createUser(org.mule.modules.drupal.model.User)} method in {@link DrupalConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final User _transformedUser = ((User) evaluateAndTransform(getMuleContext(), event, CreateUserMessageProcessor.class.getDeclaredField("_userType").getGenericType(), null, user));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((DrupalConnector) object).createUser(_transformedUser);
                }
