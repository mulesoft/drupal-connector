    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final Integer _transformedUserId = ((Integer) evaluateAndTransform(getMuleContext(), event, DeleteUserMessageProcessor.class.getDeclaredField("_userIdType").getGenericType(), null, userId));
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((DrupalConnector) object).deleteUser(_transformedUserId);
                    return null;
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("deleteUser"), event, e);
        }
    }
