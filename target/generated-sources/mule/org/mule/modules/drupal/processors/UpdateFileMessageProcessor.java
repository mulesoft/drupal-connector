...
/**
 * UpdateFileMessageProcessor invokes the {@link org.mule.modules.drupal.DrupalConnector#updateFile(org.mule.modules.drupal.model.File)} method in {@link DrupalConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final File _transformedFile = ((File) evaluateAndTransform(getMuleContext(), event, UpdateFileMessageProcessor.class.getDeclaredField("_fileType").getGenericType(), null, file));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((DrupalConnector) object).updateFile(_transformedFile);
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("updateFile"), event, e);
        }
    }
